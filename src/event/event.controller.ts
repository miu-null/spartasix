...
export class EventController {
  ...
  // // }
  // @Put("/events/:id")
  // updateArticle(@Param("id") articleId: number, @Body() data: UpdateEventDto) {
  //   return this.eventService.updateEvent(articleId, data.title, data.content);
  // }

  // @Delete("/events/:id")
  // deleteArticle(@Param("id") articleId: number, @Body() data: DeleteEventDto) {
