...
export class ClubCommentLikes {
  @PrimaryGeneratedColumn({ type: "int", name: "clubCommentLikeId" })
  clubCommentLikeId: number;
  ...
  @ManyToOne(() => ClubComments, (clubComments: ClubComments) => clubComments.clubCommentLikes)
